...
\33[31;1m██████╔╝██║██║░╚═╝░██║██║░░██║██████╔╝
\33[31;1m╚═════╝░╚═╝╚═╝░░░░░╚═╝╚═╝░░╚═╝╚═════╝░
\033[1;41;97Dimas Satrio VT \033[0m
 """
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
def tokenz():
	...
	try:
		...
		zedd.write(toket)
		zedd.close()
		jalan ('\033[1;97m JANGAN LUPA ADD AKUN GW CUK')
		print '\033[1;97m[\033[1;39m✓\033[1;97m]\033[1;39m Alhamdulillah'
		os.system('xdg-open  https://www.facebook.com/USERLORD987REVO')
		bot_komen()
	except KeyError:
